...
calc_features<-function(p){
    ...
    result$EMA1<-(EMA(Adjp,n=10,ratio=0.9)/Adjp)[,1]
    result$EMA2<-(EMA(Adjp,n=16,ratio=0.9)/Adjp)[,1]
    result$EMA3<-(EMA(Adjp,n=22,ratio=0.9)/Adjp)[,1]
    result$EMA4<-(EMA(Adjp,n=10,ratio=0.84)/Adjp)[,1]
    result$EMA5<-(EMA(Adjp,n=16,ratio=0.84)/Adjp)[,1]
    result$EMA6<-(EMA(Adjp,n=22,ratio=0.84)/Adjp)[,1]
    result$EMA7<-(EMA(Adjp,n=10,ratio=0.78)/Adjp)[,1]
    result$EMA8<-(EMA(Adjp,n=16,ratio=0.78)/Adjp)[,1]
    result$EMA9<-(EMA(Adjp,n=22,ratio=0.78)/Adjp)[,1]
    
    result$SMA1<-(SMA(Adjp,10)/Adjp)[,1]
    result$SMA2<-(SMA(Adjp,16)/Adjp)[,1]
    result$SMA3<-(SMA(Adjp,22)/Adjp)[,1]
    ...
    temp<-MACD(Adjp,nFast = 12,nSlow=18,nsig=9,percent = TRUE)
    ...
    temp<-MACD2<-MACD(Adjp,nFast = 12,nSlow=24,nsig=9,percent = TRUE)
    ...
    temp<-MACD(Adjp,nFast = 12,nSlow=30,nsig=9,percent = TRUE)
